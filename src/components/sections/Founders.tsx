  ...
  return (
    ...
    >
      <div className="grid gap-10 lg:grid-cols-[0.9fr_1.1fr] lg:items-end lg:gap-16">
        <div>
          <p className="label-xs mb-5">Who you&rsquo;ll deal with</p>
          <h2 className="display text-[clamp(1.9rem,3.6vw,3.4rem)]">
            Two people <span className="text-primary">no handover</span>
          </h2>
          <p className="mt-6 max-w-md text-base leading-relaxed text-muted-foreground sm:text-lg">
            You talk to whoever builds it with no account manager and no
            being passed around
          </p>
        </div>
