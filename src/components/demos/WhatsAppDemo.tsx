...
const CHATS = [
  { name: "Dave — Oak St", msg: "hi, my AC is blowing warm air", time: "6:02 PM", unread: 2, tint: "#6b9b8a" },
  ...
  { name: "Mike (Tech)", msg: "Finished the Kensington job", time: "2:58 PM", unread: 0, tint: "#9b7b8b" },
];
